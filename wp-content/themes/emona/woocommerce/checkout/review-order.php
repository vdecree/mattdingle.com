...
<div id="order_review">
	...
	<h3 id="order_review_heading"><?php _e( 'Your order', 'emona' ); ?></h3>
	...
	<div id="payment">
		...
		<div class="form-row place-order">
			...
			echo apply_filters( 'woocommerce_order_button_html', '<button class="btn btn-style-1 btn-md" type="submit" class="alt" name="woocommerce_checkout_place_order" id="place_order" data-value="' . esc_attr( $order_button_text ) . '">' . esc_attr( $order_button_text ) . '</button>' );
			?>
