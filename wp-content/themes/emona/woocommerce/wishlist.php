        ...
        <div class="col-md-9">
            ...
            <?php
                ...
                if( !empty( $wishlist_title ) )
                    { echo apply_filters( 'yith_wcwl_wishlist_title', '<h3 class="myaccount-heading">' . $wishlist_title . '</h3>' ); }
            ?>
            <form id="yith-wcwl-form" action="<?php echo esc_url( $yith_wcwl->get_wishlist_url() ) ?>" method="post">
                ...
                <table class="shop_table cart wishlist_table" cellspacing="0">
                	<thead>
                		<tr>
                			<th class="product-thumbnail"><?php _e( 'Item', 'yit' ) ?></th>
                			...
                			<th class="wishlist-in-stock"><span class="nobr"><?php _e( 'Stock Status', 'yit' ) ?></span></th>
                            <th class="wishlist-add"><span class="nobr"></th>
