...
<form class="shipping_calculator" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">
	...
	<section style="display: block !important;" class="shipping-calculator-form">
		...
		<p class="form-row"><button type="submit" name="calc_shipping" value="1" class="btn btn-md btn-style-1"><?php _e( 'Update Totals', 'woocommerce' ); ?></button></p>
