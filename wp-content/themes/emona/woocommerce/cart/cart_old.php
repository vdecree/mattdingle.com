...
<form name="cart-form" class="clearfix" action="<?php echo esc_url( $woocommerce->cart->get_cart_url() ); ?>" method="post">

<?php do_action( 'woocommerce_before_cart_table' ); ?>

<table class="shop_table cart span9" cellspacing="0">
...
<div class="cart-collaterals span3">
...
<?php if ( $woocommerce->cart->coupons_enabled() ) { ?>
	<div class="coupon">
		...
		<input placeholder="<?php _e("Enter coupon code", "emona"); ?>" class="input-text" class="coupon-code" value="" /> <input type="submit" class="button" name="apply_coupon" value="" />
