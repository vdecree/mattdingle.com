...
<div id="readmore_wrapper">
    ...
    <div id="readmore_1">
        ...
        <select name="parallax" id="parallax">
    ...
    <div id="readmore_1">
        ...
        <select name="parallax_overlay" id="parallax_overlay">
            <option value="false">false</option>
            <option value="true">true</option>
        </select>
    </div> 
...
function anps_getValue() { 
    var values = '';
    var parallax, parallax_overlay, slug, image;
    parallax = document.getElementById('parallax').value;
    parallax_overlay = document.getElementById('parallax_overlay').value;
    slug = document.getElementById('slug').value;
    image = document.getElementById('image').value;
    text = document.getElementById('text').value;
    
    values = '[statement image="' + image + '" slug="' + slug + '" parallax="' + parallax + '" parallax_overlay="' + parallax_overlay + '"]' + text + '[/statement]<br>';
