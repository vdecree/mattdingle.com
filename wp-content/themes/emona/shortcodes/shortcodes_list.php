...
<div id="readmore_wrapper">
    ...
    <div id="list_item_1">
        ...
        <textarea id="list-item-1" cols="30" rows="10"></textarea>
    </div>
    
    <div id="list_item_2">
        <label>List item 2: </label>
        <textarea id="list-item-2" cols="30" rows="10"></textarea>
    </div>
    
    <div id="list_item_3">
        <label>List item 3: </label>
        <textarea id="list-item-3" cols="30" rows="10"></textarea>
    </div>
...
function anps_getValue() { 
    var values = '';
    var type, listItem1, listItem2, listItem3;
    type = document.getElementById('type').value;
    listItem1 = document.getElementById('list-item-1').value;
    listItem2 = document.getElementById('list-item-2').value;
    listItem3 = document.getElementById('list-item-3').value;
    
    values = '[list type="' + type + '"]<br />' 
    		 + '[list_item]' + listItem1 + '[/list_item]<br />'
    		 + '[list_item]' + listItem2 + '[/list_item]<br />'
    		 + '[list_item]' + listItem3 + '[/list_item]<br />'
    		 + '[/list]';
