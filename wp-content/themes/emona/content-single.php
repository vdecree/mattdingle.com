                ...
                <div class="post-meta">
                    ...
                    <?php
                        ...
                        foreach ($categories as $cat) {
                            ...
                            echo '<a class="post-meta-cat" href="' . get_category_link( $cat ) . '">' . $cat->name . '</a>';
                        }
                    ?>

                    <span class="glyphicon glyphicon-comment"></span>
                    <a href="<?php echo the_permalink(); ?>#comments"><?php echo __('Comments', ANPS_TEMPLATE_LANG); ?> / <?php echo $post->comment_count; ?></a>
                </div>
            </header>
