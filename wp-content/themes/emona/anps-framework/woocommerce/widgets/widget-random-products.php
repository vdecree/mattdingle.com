...
class Custom_WC_Widget_Random_Products extends WC_Widget_Random_Products {
							...
							<div class="image">
								<?php
									if ( has_post_thumbnail() )
										the_post_thumbnail( 'product-widget' );
									else
										echo woocommerce_placeholder_img( 'product-widget' );
								?>
							</div>
						</a>
